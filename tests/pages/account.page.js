export const depositOption = '[ng-class="btnClass2"]';
export const depositSubmit = 'form.ng-dirty > .btn';
export const amountInputField = '.form-control';
export const responseWording = '.error';
export const successDeposit = 'Deposit Successful';
